...
#include <bits/stdc++.h> // "#include" is a feature of the g++ compiler, and in this case, it is used to include the entire standard library, just simplicity sake for the programmer
